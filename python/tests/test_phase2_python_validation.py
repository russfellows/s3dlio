...
def test_python_streaming_interface():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Get a streaming writer (with framework parameter)
        stream = writer.get_distributed_shard_stream(checkpoint_id, "streaming_shard", framework="python_test")
...
def test_streaming_memory_efficiency():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        stream = writer.get_distributed_shard_stream(checkpoint_id, "large_streaming_shard", framework="python_test")
...
def test_error_handling():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        stream = writer.get_distributed_shard_stream(checkpoint_id, "cancelled_shard", framework="python_test")
