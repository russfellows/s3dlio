# s3dlio Changelog - Historical (Pre-0.8.0)

This file contains the historical changelog entries for s3dlio versions prior to 0.8.0.

For current changelog entries (v0.8.0 and later), see [Changelog.md](Changelog.md).
